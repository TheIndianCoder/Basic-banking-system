...
<body style="background:#96D678;background-size: 100%">
  ...
  if (isset($_POST['saveAccount'])) {
    if (
      !$con->query("insert into useraccounts (name,cnic,accountNo,accountType,city,address,email,password,balance,source,number,branch) 
    values ('$_POST[name]','$_POST[adhar]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")
    ) {
          ...
          <tbody>
            <tr>
              <form method="POST">
                ...
                <th>Adhar Number</th>
                <td><input type="number" name="adhar" class="form-control input-sm" required></td>
            </tr>
            <tr>
              <th>Account Number</th>
              <td><input type="" name="accountNo" readonly value="<?php echo time() . rand(100, 100000) ?>"
            ...
            <tr>
              <th>Deposit</th>
              <td><input type="phone" name="balance" min="500" class="form-control input-sm" required></td>
              <th>Source of income</th>
              <td><input type="text" name="source" class="form-control input-sm" required></td>
            </tr>
            <tr>
              <th>Contact Number</th>
              <td><input type="phone" name="number" class="form-control input-sm" required></td>
              <th>Branch</th>
              <td>
